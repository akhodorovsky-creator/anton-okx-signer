...
test('20 EUR order cap respects exchange minimum and rejects excess',()=>{assert.equal(orderSize({state:'live',minSz:'0.0001',lotSz:'0.00000001'},67000,5).valid,false);assert.equal(orderSize({state:'live',minSz:'0.0001',lotSz:'0.00000001'},67000,20).valid,true);assert.equal(orderSize({state:'live',minSz:'1',lotSz:'1'},0.2,20).valid,true);assert.equal(orderSize({state:'suspend',minSz:'1',lotSz:'1'},0.2,20).valid,false);assert.equal(orderSize({state:'live',minSz:'1',lotSz:'1'},0.2,21).valid,false);});
