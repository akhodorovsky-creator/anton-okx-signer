...
if(require.main===module)run();module.exports={PAIRS,ledger,reportLedger,applyPnlBaseline,parsePnlBaselines,uniqueOrders,orderSize,sellSize,page,handler,tick,portfolio};
