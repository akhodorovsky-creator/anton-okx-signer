...
const PNL_RESET_AT=Math.max(0,Number(process.env.PNL_RESET_AT||0));
...
function reportLedger(orders,price){return ledger(PNL_RESET_AT?orders.filter(o=>Number(o.cTime||0)>=PNL_RESET_AT):orders,price);}
